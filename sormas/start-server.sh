...
sed -i "s;app.url=.*;app.url=https://${SORMAS_SERVER_URL}/downloads/release/sormas-1.38.0-release.apk;" ${DOMAIN_DIR}/sormas.properties
sed -i "s/country.name=.*/country.name=nigeria/" ${DOMAIN_DIR}/sormas.properties
